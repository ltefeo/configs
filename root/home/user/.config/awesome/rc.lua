...
globalkeys =
    ...
    awful.key(
        ...
        {description = "rofi", group = "altkey"}
    ),
    -- screenshots
    --     awful.key({ }, "Print", function () awful.util.spawn("scrot 'ScreenShot-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
    ...
    awful.key({modkey}, "l", awful.client.urgent.jumpto, {description = "jump to urgent client", group = "client"}),
    awful.key(
        {modkey1},
        "Tab",
        function()
